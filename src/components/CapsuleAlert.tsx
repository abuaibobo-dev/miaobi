...
const styles = StyleSheet.create({
  ...
  confirmBtn: { flex: 1, height: 42, borderRadius: 20, backgroundColor: T.white, alignItems: 'center', justifyContent: 'center' },
  dangerBtn: { backgroundColor: T.surface2 },
  confirmText: { fontSize: 14, fontWeight: '700', color: T.black },
  ...
  toastText: { fontSize: 12, fontWeight: '600', color: T.black, textAlign: 'center' },
});
