...
export default StyleSheet.create({
  ...
  bubble: { maxWidth: '88%', borderRadius: 19, paddingHorizontal: 13, paddingVertical: 10 },
  ai: { alignSelf: 'flex-start', backgroundColor: T.surface, borderWidth: 1, borderColor: T.border, borderBottomLeftRadius: 7 },
  user: { alignSelf: 'flex-end', backgroundColor: '#D9D9D9', borderBottomRightRadius: 7 },
  messageText: { color: '#D6D6D6', fontSize: 14, lineHeight: 22 },
  userText: { color: '#111' },
  ...
  inputBar: {
    ...
    borderRadius: 25, backgroundColor: T.surface, borderWidth: 1, borderColor: T.borderLight,
    paddingHorizontal: 15, paddingVertical: 9,
  },
  input: { flex: 1, minHeight: 30, color: T.text, fontSize: 15, textAlignVertical: 'center' },
  send: { width: 34, height: 34, borderRadius: 17, backgroundColor: '#E7E7E7', alignItems: 'center', justifyContent: 'center' },
  disabled: { opacity: 0.4 },
  resultBlock: { width: '100%', borderRadius: 18, backgroundColor: '#161616', borderWidth: 1, borderColor: T.border, padding: 12 },
  resultLabel: { color: T.text, fontSize: 13, fontWeight: '900', marginBottom: 9 },
  resultCard: { flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 9, borderTopWidth: 1, borderTopColor: '#222' },
  resultTitle: { color: T.text, fontSize: 13, fontWeight: '700' },
  resultMeta: { marginTop: 3, color: T.textMuted, fontSize: 10 },
  openText: { color: '#E5E5E5', fontSize: 11, fontWeight: '800' },
});
