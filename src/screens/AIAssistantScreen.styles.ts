...
export default StyleSheet.create({
  ...
  inputBar: {
    ...
    marginHorizontal: 14, marginTop: 6, marginBottom: 10, minHeight: 50, maxHeight: 150,
    borderRadius: 20, backgroundColor: T.surface, borderWidth: 1, borderColor: T.borderLight,
    paddingHorizontal: 15, paddingVertical: 9,
  },
  input: { flex: 1, minHeight: 40, maxHeight: 130, color: T.text, fontSize: 15, lineHeight: 22, paddingVertical: 8 },
  send: { width: 40, height: 40, borderRadius: 20, backgroundColor: T.white, alignItems: 'center', justifyContent: 'center' },
