...
export default StyleSheet.create({
  ...
  send: { width: 34, height: 34, borderRadius: 17, backgroundColor: T.white, alignItems: 'center', justifyContent: 'center' },
  disabled: { opacity: 0.4 },
  resultBlock: { width: '100%', borderRadius: 18, backgroundColor: T.surface, borderWidth: 1, borderColor: T.border, padding: 12 },
