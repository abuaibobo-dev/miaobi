...
export default StyleSheet.create({
  ...
  cover: { width: 118, height: 164, borderRadius: 14, backgroundColor: T.surface2, borderWidth: 1, borderColor: T.borderLight, alignItems: 'center', justifyContent: 'center', overflow: 'hidden' },
  coverImage: { width: '100%', height: '100%' },
  meta: { flex: 1, minWidth: 0 },
  title: { color: T.text, fontSize: 21, lineHeight: 28, fontWeight: '900' },
  authors: { marginTop: 7, color: T.textSec, fontSize: 13 },
  badge: { alignSelf: 'flex-start', marginTop: 10, borderRadius: 10, backgroundColor: '#E7E7E7', paddingHorizontal: 9, height: 22, lineHeight: 22, fontSize: 11, fontWeight: '800', color: T.black, overflow: 'hidden' },
  ...
  subject: { borderRadius: 11, backgroundColor: T.surface2, paddingHorizontal: 10, height: 23, lineHeight: 23, fontSize: 11, color: T.textSec, overflow: 'hidden' },
  primaryButton: { height: 48, marginTop: 24, borderRadius: 24, backgroundColor: T.white, alignItems: 'center', justifyContent: 'center' },
  ...
  aiButton: { height: 41, marginTop: 9, borderRadius: 21, backgroundColor: T.surface2, borderWidth: 1, borderColor: T.borderLight, alignItems: 'center', justifyContent: 'center' },
