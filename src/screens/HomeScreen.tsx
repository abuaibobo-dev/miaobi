...
const s: any = {
  ...
  inputArea: { paddingHorizontal: 12, paddingBottom: 24, backgroundColor: T.bg },
  ...
  input: { flex: 1, color: T.text, fontSize: 14, backgroundColor: T.surface2, borderRadius: T.radius, paddingHorizontal: 14, paddingTop: 10, paddingBottom: 10, maxHeight: 100, borderWidth: 1, borderColor: T.border },
  sendBtn: { width: 36, height: 36, borderRadius: 18, backgroundColor: T.white, alignItems: 'center', justifyContent: 'center' },
