...
export default StyleSheet.create({
  ...
  iconButton: { width: 36, height: 36, borderRadius: 18, backgroundColor: T.surface, borderWidth: 1, borderColor: T.border, alignItems: 'center', justifyContent: 'center' },
  ...
  navButton: { flexDirection: 'row', alignItems: 'center', gap: 3, height: 35, borderRadius: 18, paddingHorizontal: 11, backgroundColor: T.surface, borderWidth: 1, borderColor: '#2E2E2E' },
