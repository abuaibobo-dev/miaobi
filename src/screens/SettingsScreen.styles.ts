...
export default StyleSheet.create({
  ...
  primaryButton: { height: 46, marginTop: 20, borderRadius: 23, backgroundColor: T.white, alignItems: 'center', justifyContent: 'center' },
  ...
  toast: { marginTop: 12, borderRadius: 15, backgroundColor: T.surface2, borderWidth: 1, borderColor: T.borderLight, paddingVertical: 10, paddingHorizontal: 14 },
  ...
  confirmYes: { height: 30, borderRadius: 15, paddingHorizontal: 12, justifyContent: 'center', backgroundColor: T.surface2 },
