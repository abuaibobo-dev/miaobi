...
export default StyleSheet.create({
  ...
  sectionCard: { borderRadius: 16, backgroundColor: T.surface, borderWidth: 1, borderColor: T.border, padding: 16 },
  ...
  input: {
    minHeight: 42, maxHeight: 100, borderRadius: 12, backgroundColor: T.surface2,
    borderWidth: 1, borderColor: T.borderLight, paddingHorizontal: 13,
    color: T.text, fontSize: 14, textAlignVertical: 'center',
  },
  primaryButton: { height: 46, marginTop: 20, borderRadius: 20, backgroundColor: T.white, alignItems: 'center', justifyContent: 'center' },
  primaryText: { color: T.black, fontSize: 14, fontWeight: '900' },
  secondaryButton: { height: 41, marginTop: 9, borderRadius: 20, backgroundColor: T.surface, borderWidth: 1, borderColor: T.borderLight, alignItems: 'center', justifyContent: 'center' },
  secondaryText: { color: T.text, fontSize: 13, fontWeight: '700' },
  disabled: { opacity: 0.55 },
  toast: { marginTop: 12, borderRadius: 12, backgroundColor: T.surface2, borderWidth: 1, borderColor: T.borderLight, paddingVertical: 10, paddingHorizontal: 14 },
  toastText: { color: T.text, textAlign: 'center', fontSize: 12 },
  aboutCard: { marginTop: 22, borderRadius: 16, backgroundColor: T.surface, borderWidth: 1, borderColor: T.border, padding: 15 },
  menuGrid: { flexDirection: 'row', gap: 10, marginTop: 16 },
  menuButton: { flex: 1, borderRadius: 16, backgroundColor: T.surface, borderWidth: 1, borderColor: T.border, padding: 14 },
