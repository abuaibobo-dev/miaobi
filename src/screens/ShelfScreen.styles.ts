...
export default StyleSheet.create({
  ...
  importButton: { height: 34, borderRadius: 17, paddingHorizontal: 11, justifyContent: 'center', backgroundColor: T.card, borderWidth: 1, borderColor: T.borderLight },
  importText: { color: T.textSec, fontSize: 11, fontWeight: '700' },
  tabs: { flexDirection: 'row', flexWrap: 'wrap', gap: 7, padding: 15 },
  tabChip: { minHeight: 30, borderRadius: 15, paddingHorizontal: 11, justifyContent: 'center', backgroundColor: T.surface, borderWidth: 1, borderColor: T.border },
  ...
  card: { borderRadius: 17, backgroundColor: T.surface, borderWidth: 1, borderColor: T.border, padding: 11 },
  cover: { width: 54, height: 76, borderRadius: 9, backgroundColor: '#222', alignItems: 'center', justifyContent: 'center', overflow: 'hidden' },
