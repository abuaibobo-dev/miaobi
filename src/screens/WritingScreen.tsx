...
const s: any = {
  ...
  inputContainer: { backgroundColor: T.surface2, borderRadius: 20, borderWidth: 1, borderColor: T.border, paddingHorizontal: 8, paddingTop: 8, paddingBottom: 7, minHeight: 132 },
  inputBody: { flexDirection: 'row', alignItems: 'flex-end', marginTop: 4 },
  input: { flex: 1, color: T.text, fontSize: 15, maxHeight: 240, paddingHorizontal: 6, paddingTop: 8, paddingBottom: 8, lineHeight: 22, minHeight: 82 },
